...
- **MiniMax** — analysis (`MiniMax-M3`) through the recommended Anthropic-compatible endpoint (`https://api.minimaxi.com/anthropic`) and speech (`speech-2.8-turbo`, `speech-2.8-hd`).
